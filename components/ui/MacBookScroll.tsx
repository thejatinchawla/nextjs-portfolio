...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="md:h-[130vh] hidden  md:flex flex-col items-center py-0 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
